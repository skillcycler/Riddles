...
public class Swapper : Role
{
    ...
    private void CharacterPicked()
    {
        ...
        if (chars[0].bluff)
        {
            if (chars[0].bluff.characterId == "Swapper_scm" || chars[0].bluff.characterId == "Devout_WING")
            {
                return;
            }
        }
        if (chars[0].dataRef.characterId == "Swapper_scm" || chars[0].dataRef.characterId == "Devout_WING")
        {
            return;
        }
        if (chars[1].bluff)
        {
            if (chars[1].bluff.characterId == "Swapper_scm" || chars[1].bluff.characterId == "Devout_WING")
            {
                return;
            }
        }
        if (chars[1].dataRef.characterId == "Swapper_scm" || chars[1].dataRef.characterId == "Devout_WING")
        {
            return;
        }
