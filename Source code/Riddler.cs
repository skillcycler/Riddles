...
public class Riddler : Role
{
    ...
    public override ActedInfo GetInfo(Character charRef)
    {
        ...
        infos.Add("A Truthful Bishop will only name 2 cards if Wretch is the only Outcast.");
        ...
        infos.Add("The Dreamer can be used every night.");
        ...
        infos.Add("A lying Druid targeting a non-Wretch Outcast will say there are no Outcasts.");
        ...
        infos.Add("The Werewolf can tell the truth when not disguising as the Confessor.");
        infos.Add("The Drunk can sometimes tell the truth.");
        infos.Add("Corrupted characters can sometimes tell the truth.");
        infos.Add("A Demon can shut up a truthful Rambler.");
        infos.Add("A lying Druid can mention a not in deck Outcast.");
    ...
    public override ActedInfo GetBluffInfo(Character charRef)
    {
        ...
        infos.Add("The Judge, Fortune Teller, and Investigator can be used every night.");
        ...
        infos.Add("A lying Medium can call out a Lycanthrope.");
        ...
        infos.Add("The Drunk always lies.");
        infos.Add("Corrupted characters always lie.");
        infos.Add("A Demon cannot shut up a truthful Rambler.");
        infos.Add("A Scout can say \"Puppet is 4 cards away from closest Evil\".");
        infos.Add("The Oracle can point to the Wretch when there are other Minions in play.");
        infos.Add("A lying Hunter can point to a non-closest Evil.");
        infos.Add("A lying Bard can point to a non-closest Corrupted character.");
