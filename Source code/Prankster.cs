...
public class Prankster : Role
{
    ...
    public override void Act(ETriggerPhase trigger, Character charRef)
    {
        ...
        {
            Il2CppSystem.Collections.Generic.List<Character> c = Gameplay.CurrentCharacters;
            Il2CppSystem.Collections.Generic.List<Character> goods = Characters.Instance.FilterRealAlignmentCharacters(c, EAlignment.Good);
            Il2CppSystem.Collections.Generic.List<Character> evils = Characters.Instance.FilterRealAlignmentCharacters(c, EAlignment.Evil);
